...
#include "stm32f4xx_hal.h" /* HAL_StatusTypeDef, I2C_HandleTypeDef, uint16_t */
...
#define ADS1115_PGA_TWOTHIRDS                                                  \
  (0b000 << 1) // 2/3x Gain	-- 0.1875 mV by one bit		MAX: +- VDD +
               // 0.3V
#define ADS1115_PGA_ONE                                                        \
  (0b001 << 1) // 1x Gain		-- 0.125 mV by one bit		MAX: +-
               // VDD + 0.3V
#define ADS1115_PGA_TWO                                                        \
  (0b010 << 1) // 2x Gain		-- 0.0625 mV by one bit		MAX:
               // +- 2.048 V
#define ADS1115_PGA_FOUR                                                       \
  (0b011 << 1) // 4x Gain		-- 0.03125 mV by one bit	MAX:
               // +- 1.024 V
#define ADS1115_PGA_EIGHT                                                      \
  (0b100 << 1) // 8x Gain		-- 0.015625 mV by one bit	MAX: +-
               // 0.512 V
#define ADS1115_PGA_SIXTEEN                                                    \
  (0b111 << 1) // 16x Gain		-- 0.0078125 mV by one bit	MAX: +-
               // 0.256 V
